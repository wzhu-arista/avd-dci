...
router bgp 65204
   address-family evpn
      ...
      neighbor EVPN-OVERLAY-PEERS rcf in matchComm()
      neighbor EVPN-OVERLAY-PEERS rcf out addComm()
   
      neighbor EVPN-OVERLAY-CORE rcf in matchComm()
      neighbor EVPN-OVERLAY-CORE rcf out addComm()
