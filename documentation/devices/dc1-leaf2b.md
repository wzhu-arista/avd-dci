...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 192.168.124.108/24 | 192.168.124.1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | dc1-leaf2-server1_eth2 | *trunk | *11-12,21-22 | *4092 | *- | 5 |
...
!
interface Ethernet5
   description dc1-leaf2-server1_eth2
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel5 | dc1-leaf2-server1_PortChannel dc1-leaf2-server1 | switched | trunk | 11-12,21-22 | 4092 | - | - | - | - | - |
| Port-Channel8 | DC1-LEAF2C_Po1 | switched | trunk | 11-12,21-22,3401-3402 | - | - | - | - | - | 0000:0000:0001:0202:0202 |
...
| --------- | --------------------------- | --------------------------- | ------------ |
| Port-Channel8 | 0000:0000:0001:0202:0202 | all-active | 00:01:02:02:02:02 |
...
interface Port-Channel8
   ...
   evpn ethernet-segment
      identifier 0000:0000:0001:0202:0202
      route-target import 00:01:02:02:02:02
   lacp system-id 0001.0202.0202
```
